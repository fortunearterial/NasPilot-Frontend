export default {
  ...
  setting: {
    ...
    system: {
      ...
      apiToken: 'API Token',
      apiTokenHint: 'Set the token value used when external requests access NasPilot API',
    ...
    site: {
      ...
      autoSyncIntervalHint: 'Time interval for automatically syncing site cookies from CookieCloud server to NasPilot',
  ...
  dialog: {
    ...
    pluginMarketSetting: {
      ...
      repoPlaceholder: 'Format: https://github.com/jxxghp/NasPilot-Plugins/,https://github.com/xxxx/xxxxxx/',
