export default {
  ...
  setting: {
    ...
    system: {
      ...
      apiToken: 'API令牌',
      apiTokenHint: '設置外部請求NasPilot API時使用的token值',
    ...
    site: {
      ...
      autoSyncIntervalHint: '從CookieCloud服務器自動同步站點Cookie到NasPilot的時間間隔',
